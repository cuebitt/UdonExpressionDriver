...
namespace Cuebitt.UdonExpressionDriver.Editor.Templates
{
    ...
    public partial class UEDDriverTemplate : UEDDriverTemplateBase
    {
        /// <summary>
 ...
 foreach (var item in Parameters.ToList())
   {
       ...
       var privateName = "_" + char.ToLowerInvariant(item.name[0]) + item.name[1..];
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(privateName + "Default"));
 ...
 foreach (var item in Parameters.ToList().Where(p => p.networkSynced))
   {
       ...
       var animatorMethodTypeFormatted = item.type switch {
           ...
           _ => "Float"
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(privateName + "Hash"));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(defaultValueFormatted));
 ...
 foreach (var item in Parameters.ToList().Where(p => !p.networkSynced))
   {
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class UEDDriverTemplateBase
    {
        #region Fields
